...
object IrwsInstances {
  ...
  implicit def irwsApplicativeAsk[F[_]: Applicative, E, L, S](implicit
      ev: Applicative[IndexedReaderWriterStateT[F, E, L, S, S, *]],
      monoid: Monoid[L]
  ...
  implicit def irwsFunctorTell[F[_]: Applicative, E, L, S](implicit
      ev: Functor[IndexedReaderWriterStateT[F, E, L, S, S, *]]
  ...
  implicit def irwsMonadState[F[_]: Monad, E, L, S](implicit
      ev: Monad[IndexedReaderWriterStateT[F, E, L, S, S, *]],
      monoid: Monoid[L]
