...
object ZioInstances {
  ...
  implicit def zioApplicativeAsk[E: Tag, L, S](implicit
      ev: Applicative[ZIOReaderWriterState[E, L, S, *]],
      monoid: Monoid[L]
  ...
  implicit def zioFunctorTell[E, L, S](implicit
      ev: Functor[ZIOReaderWriterState[E, L, S, *]],
      monoid: Monoid[L],
      tag: Tag[Ref[L]]
  ...
  implicit def zioMonadState[E, L, S](implicit
      ev: Monad[ZIOReaderWriterState[E, L, S, *]],
      tag: Tag[Ref[S]]
